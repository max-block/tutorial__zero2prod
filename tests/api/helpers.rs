...
pub async fn spawn_app() -> TestApp {
    ...
    let application = Application::build(conf.clone()).await.expect("Failed to build application.");
    ...
    TestApp {
        ...
        port,
        email_server,
        db_pool: get_connection_pool(&conf.database).await.expect("Failed to connect to the database"),
    }
}
